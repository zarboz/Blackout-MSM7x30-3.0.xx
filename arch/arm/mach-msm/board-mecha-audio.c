...
static unsigned aux_pcm_gpio_off[] = {
  GPIO_CFG(MECHA_GPIO_BT_PCM_OUT, 0, GPIO_CFG_INPUT,
			GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
  GPIO_CFG(MECHA_GPIO_BT_PCM_IN, 0, GPIO_CFG_INPUT,
                      GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
  GPIO_CFG(MECHA_GPIO_BT_PCM_SYNC, 0, GPIO_CFG_INPUT,
			GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
  GPIO_CFG(MECHA_GPIO_BT_PCM_CLK, 0, GPIO_CFG_INPUT,
                      GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
};
...
void __init mecha_audio_init(void)
{
	...
	pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(MECHA_AUD_SPK_SD, &tpa2051_pwr);

	if (system_rev == 0)
		pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(MECHA_GPIO_AUD_AMP_EN_XA, &tpa2051_pwr);
	else {
