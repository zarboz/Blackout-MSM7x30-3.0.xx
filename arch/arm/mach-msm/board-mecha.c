...
static int pm8058_gpios_init(void)
{
	...
	/*static struct pm_gpio keypad_led = {
		.direction		= PM_GPIO_DIR_OUT,
		.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		.output_value	= 0,
		.pull			= PM_GPIO_PULL_NO,
	...
	/* Headset */
	static struct pm_gpio aud_hp_detz = {
...
//	if ((engineerid & 0x3) == 0x0)
	...
	static struct pm_gpio ps_int_n = {
		.direction		= PM_GPIO_DIR_IN,
		.output_buffer	= 0,
		.output_value	= 0,
	...
	/* MicroP INT*/
	static struct pm_gpio up_int_n = {
		.direction		= PM_GPIO_DIR_IN,
		.output_buffer	= 0,
		.output_value	= 0,
		.pull			= PM_GPIO_PULL_NO,
	...
	/* G Sensor INT*/
	static struct pm_gpio gsensor_int_n = {
		.direction		= PM_GPIO_DIR_IN,
		.output_buffer	= 0,
		.output_value	= 0,
		.pull			= PM_GPIO_PULL_NO,
	...
	/* E-Compass INT */
	static struct pm_gpio compass_int_n = {
		.direction		= PM_GPIO_DIR_IN,
		.output_buffer	= 0,
		.output_value	= 0,
		.pull			= PM_GPIO_PULL_NO,
	...
	/* uP Reset */
	static struct pm_gpio up_reset_n = {
		.direction		= PM_GPIO_DIR_OUT,
		.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		.output_value	= 1,
		.pull			= PM_GPIO_PULL_NO,
	...
	/* usb hub switch */
//	if (system_rev >= 2)
	static struct pm_gpio usb_hub_switch = {
		.direction		= PM_GPIO_DIR_OUT,
		.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		.output_value	= 0,
		.pull			= PM_GPIO_PULL_NO,
	...
	rc = pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(MECHA_AUD_HP_DETz), &aud_hp_detz);
	if (rc) {
	...
	rc = pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(MECHA_GPIO_SDMC_CD_N), &sdmc_cd_n);
	if (rc) {
